...
Given a data set with the following structure the aim of this assignment is to implement a probabilistic generative model and a iterative least squares model to compare and contrast their performance on a dataset. 

The dataset consists of 270 training examples and 146 test examples which each have 18 features characterizing the class. There are two classed, SAAB (C =2) and VAN (C = 4).
